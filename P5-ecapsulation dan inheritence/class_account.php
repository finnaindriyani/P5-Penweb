...
?>
<?php
$p1 = new accountBank("", "Hendery", "");
$p1->daftar();
$p1->nabung(52000000);

$p2 = new accountBank("", "Yangyang","" );
$p2->daftar();
$p2->tarik(51500000);
?>

<?php
    $p1 = ['id'=> 1, 'nomor' => 'C001', 'nama' => 'Hendery', 'saldo' => 56000000];
    $p2 = ['id'=> 2, 'nomor' => 'C002', 'nama' => 'Yangyang', 'saldo' => 55350000];
    $p3 = ['id'=> 3, 'nomor' => 'C003', 'nama' => 'Kun ', 'saldo' => 33500000];
