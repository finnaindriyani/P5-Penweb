...
echo "Nama Minuman : " . $minuman -> namaMinuman  = 'Cola-cola';
echo "<hr/> <br/>";
echo "Volume galon nya adalah " .$minuman -> volume(1000). " Ml";
echo "<br/>";
echo "Harga Segelas nya adalah " .$minuman -> hargaSegelas(10000)." Rupiah";
echo "<br/>";
echo "Hendery beli air 1 gelas yang volumenya ".Dispenser::volumegelas . " Ml";
echo "<br/>";
